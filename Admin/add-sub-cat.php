...
<?php if (isset($_POST['sub_category'])) {
     ...
     if (!empty($subcategory) && !empty($subcategory)) {
           ...
           if (!preg_match("/^[a-zA-Z0-9-' ]*$/", $subcategory)) {
                ...
                $insertsubcat=mysqli_query($conn,"INSERT INTO sub_category (sub_cat_name,category_id)values('$subcategory',$categoryname)");
                if($insertsubcat){
        ...
        <div class="col col-lg-6 col-md-6 col-sm12">
            ...
            <form action="" method="post" enctype="multipart/form-data">
                <div class="form-group">
                    ...
                    <input type="text" id="category" name="subcategory" class="form-control">
                </div>
